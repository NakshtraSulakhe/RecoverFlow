    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-8">
      <Card className={cn('border max-w-md w-full text-center', isDark ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200')}>
        <CardContent className="p-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">401 Unauthorized</h1>
          <p className="text-muted-foreground mb-6">
            You don't have permission to access this resource. Please log in or contact your administrator.
          </p>
