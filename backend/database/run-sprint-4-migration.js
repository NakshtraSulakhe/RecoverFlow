...
async function runSprint4Migration() {
  const client = await pool.connect();
  try {
    console.log('Running Sprint 4 migration...');
    
    const fs = require('fs');
    const sql = fs.readFileSync('./sprint-4-schema.sql', 'utf8');
    ...
    console.log('✅ Sprint 4 migration completed successfully!');
